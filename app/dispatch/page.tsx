        ...
        {modalLoading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <Select
                label="Consignee"
                value={String(consigneeID)}
                onChange={e => setConsigneeID(Number(e.target.value))}
                options={[
                  {value: "0", label: "— Same as customer —"},
                  ...consignees.map(c => ({value: String(c.ConsigneeID), label: c.ConsigneeName ?? ""}))
                ]}
              />
              <Select
                label="Transporter"
                ...
                options={[
                  ...
                  ...transporters.map(t => ({value: String(t.TransporterID), label: t.TransporterName ?? ""}))
                ]}
              />
                        ...
                        <tr key={l.sn} className={c.cartons > 0 ? "bg-blue-50" : "hover:bg-gray-50"}>
                          ...
                          <td className={td}>
                            <Input type="number" min={0} max={editMode ? undefined : l.availableCartons}
                              ...
                              className="w-20"
                              error={over ? "Over limit" : undefined}
                            />
                          </td>
